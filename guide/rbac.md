...
![验证码Swagger](https://springboot.plus/img/rbac/rbac-verification.png)
...
![验证码Swagger](https://springboot.plus/img/rbac/rbac-login.png)
...
![验证码Swagger](https://springboot.plus/img/rbac/rbac-sys-department.png)
...
![验证码Swagger](https://springboot.plus/img/rbac/rbac-sys-role.png)
...
![验证码Swagger](https://springboot.plus/img/rbac/rbac-sys-permission.png)
