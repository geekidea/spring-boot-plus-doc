<template>
  <div class="home">
    <div class="hero">
      ...
      <p>
        <a href="/guide/" class="nav-link action-button quick-btn">快速开始 →</a>
        <a href="https://github.com/geekidea/spring-boot-plus" class="nav-link action-button go-github-btn" TARGET="_blank">
