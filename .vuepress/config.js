module.exports = {
    ...
    head: [
        ...
        ['script', {}, 'console.log("%c      :: Spring Boot ::             (v2.2.0.RELEASE)","color:blue");console.log("%c      :: Spring Boot Plus ::        (v1.4.0)","color:blue");console.log("%c      :: spring-boot-plus ::        https://springboot.plus","color:blue");'],
        ...
        locales: {
            "/": {
                ...
                nav: [
                    ...
                    {
                        text: "Swagger",
                        link: "http://47.105.159.10/api/docs"
                    },
                    {
                        text: "后端演示",
                        link: "http://47.105.159.10/api"
                    },
                    {
                        text: "前端演示",
                        link: "http://47.105.159.10"
                    }
                ],
                sidebar: {
